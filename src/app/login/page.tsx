...
export default function LoginPage() {
  ...
  if (user) {
    return (
      <div className="mx-auto flex w-full max-w-md flex-col gap-4 rounded-2xl border border-sky-200/70 bg-white/85 p-6 shadow-lg shadow-sky-100/70 backdrop-blur">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-full bg-sky-600 px-4 py-2 text-sm font-medium text-white shadow-sm shadow-sky-200 hover:bg-sky-500"
        >
          Sign out
        </button>
      </div>
